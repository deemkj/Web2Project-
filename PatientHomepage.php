...
<header> 
    ...
    <nav> 
        <ul> 
            <li><a href="Ebsar Homepage.html" class="sign-out-link">Log out</a></li> 
        </ul> 
    </nav> 
</header> 
...
<footer> 
    ...
    <div class="footer-center-1"> 
        <a href="Ebsar Homepage.html"><img src="images/2logo.png" alt="Logo" class="footer-logo-1 logo-toggle"></a> 
    </div> 
