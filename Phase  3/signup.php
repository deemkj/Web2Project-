...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_stmt_num_rows($checkId) > 0) {
        echo "<script>
                ...
                window.location.href = '../pages/Sign-Up page.html';
              </script>";
        exit();
    }
    ...
    if ($role == "patient") {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            alert('Account has been created! please log in');
             window.location.href = '../pages/Log-In page.html';
             </script>";
            exit();
        } else {
...
$uploadDir = "/Applications/MAMP/htdocs/serverImages/"; // here should be the path to serverImages folder
